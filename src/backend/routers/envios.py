...
from models import Envio, Direccion, EventoDeEnvio, Usuario, EstadoEnvioEnum, AccionEnvioEnum, NivelPrioridadEnum
from schemas import (
    ...
    EventoHistorialOut, EventoAuditoriaOut, MovimientoCreate,
)
...
def eliminar_envio(tracking_id: str, db: Session = Depends(get_db)):
    ...
    if envio.estado != EstadoEnvioEnum.CANCELADO:
        raise HTTPException(status_code=422, detail="Solo se pueden eliminar envíos en estado CANCELADO")
